...
import TodayPriorityMobile from "./TodayPriorityMobile";
  ...
  return (
    <>
      <div style={{ padding: "2px", backgroundColor: "#F9F9F9" }}>
        {isMobile ? (
          <div className="Res_Padding">
            <div
              style={{ display: "flex", flexDirection: "column", gap: "15px" }}
            >
              <div className="">
                <ProfileCardMobile usermessage={usermessage} />
              </div>
              <div className="">
                <AlertNotification alertNot={alertNot} />
              </div>
              <div>
                <TodayPriorityMobile tPriority={tPriority} refrsh={refrsh} setRefresh={setRefresh} />
              </div>
              <div className="Res_Padding">
