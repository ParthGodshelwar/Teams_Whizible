  ...
  (
    ...
    useEffect(() => {
      if (appliedFilters) {
        ...
        setmilestone(appliedFilters.milestone || []);
    ...
    const fetchUserDAEntryFilter = async () => {
      ...
      try {
        ...
        if (filterData) {
          ...
          setPhase(filterData.phase);
          setDeliverable(filterData.deliverable);
          setmilestone(filterData.milestone);
          ...
          setPreSelectedFilters({
            ...
            subProject: filterData.subProject || "",
            milestone: filterData.milestone || "",
            phase: filterData.phase || "", //added by parth.g
    ...
    useEffect(() => {
      ...
      if (selectedProject) {
        selectedProject23 = selectedProject;
