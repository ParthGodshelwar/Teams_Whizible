...
function EditMyTSRejectoffcanvas() {
  return (
    <div
      className="offcanvas offcanvas-end offcanvas-85"
      data-bs-scroll="false"
      tabIndex={-1}
      id="EditMyTSReject_offcanvas"
    >
          ...
          <div className="row d-flex justify-content-between">
            ...
            <div className="col-sm-7 ps-3 my-3 text-end">
              <span className="text-end mx-3">
                ...
                <span className="text_red  fw-500">
                  {" "}
                  <i className="fa-regular fa-clock" /> 60:00 / 40:00
                </span>
              </span>
              <span className="text-end mx-3">
                Timesheet Status - <span className="text_red  fw-500"> Rejected</span>
              </span>
            </div>
          </div>
            ...
            <div className="row">
              ...
              <div className="col-sm-3 text-end">
                <div className="input-group">
                  <input
                    id="search_Edit_RejectedInput"
                    type="text"
                    placeholder="Search Task.."
                    onkeyup="searchEdit_Rejected()"
...
export default EditMyTSRejectoffcanvas;
