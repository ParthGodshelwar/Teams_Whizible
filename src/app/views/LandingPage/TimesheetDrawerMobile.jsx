...
const TimesheetDrawerMobile = ({ drawerOpen, handleCloseDrawer, id, refrsh, setRefresh }) => {
    ...
    >
      <Box
        sx={{
          position: "relative",
          width: "100%",
          height: "90vh", // Ensure the Box takes the full viewport height
                ...
                <div className="col-sm-7">
                  ...
                  <div className="row mb-3">
                    ...
                    <div className="col-sm-7 col-12" style={{ position: "relative" }}>
                      ...
                      {/* Info Icon with Fluent UI Popover */}
                      <div
                        ref={iconRef}
                        style={{
                          position: "absolute",
                  ...
                  <div className="row mb-3">
                    ...
                    <div className="col-sm-3 col-12">
                      <input
                        ...
                        placeholder="00:00"
                        style={{ width: "120px" }} // Fixed width for efforts input
                      />
                    </div>
                  </div>
...
export default TimesheetDrawerMobile;
