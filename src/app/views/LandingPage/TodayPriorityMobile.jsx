...
import TimesheetDrawerMobile from "./TimesheetDrawerMobile";

const TodayPriorityMobile = ({ tPriority, refrsh, setRefresh }) => {
...
export default TodayPriorityMobile;
