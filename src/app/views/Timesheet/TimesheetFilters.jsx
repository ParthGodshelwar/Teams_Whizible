...
const TimesheetFilters = ({ handleFilterChange, appliedFilters, setAppliedFilters }) => {
  ...
  const fetchFiltersData = async () => {
    ...
    try {
      ...
      if (projects.length !== 0) localStorage.setItem("selectedProject", JSON.stringify(projects));
