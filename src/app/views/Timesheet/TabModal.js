  ...
  const fetchAdditionalDetails = async (taskID) => {
    try {
      ...
      if (data?.data?.listAdditinalTaskDetail) {
        ...
        setPostTillDate(new Date(details.startDate).toISOString().split("T")[0]);
        setSelectedProjectID(details.projectID);

        setSelectedTaskID(details.taskID);

        setSelectedSubTaskID(details.subTaskType);
        setAllocatedTime(details.work);
        setReason1(details.work);
  ...
  const fetchScheduleTasksDetails = async (taskID) => {
    try {
      ...
      if (data?.data?.listScheduleTaskDetail) {
        ...
        setStartDate1(new Date(details.startDate).toISOString().split("T")[0]);
  ...
  return (
    <Modal show={showTabModal} onHide={close}>
      <Modal.Header closeButton>
        <Modal.Title>DA Type Details</Modal.Title>
      </Modal.Header>
      <Modal.Body>
          ...
          <Tab.Content className="mt-3">
            ...
            <Tab.Pane eventKey="schedule">
              ...
              <div className="d-flex justify-content-end mt-3">
                ...
                <Button variant="secondary" onClick={handleCloseTabModal}>
                  Close
                </Button>
              </div>
            </Tab.Pane>
            ...
            <Tab.Pane eventKey="request">
              ...
              <div className="row mb-3">
                ...
                <div className="col-sm-8">{additionalDetails?.actualWork}</div>
              </div>
              <div className="row mb-3">
