...
const ProjectTaskTable = ({
  ...
  const handleSaveEdit = (taskID, day, newValue) => {
    ...
    console.log(`Updated dayEfforst${day} for taskID ${taskID} with value:`, newValue);
    console.log("Updated timesheetData:", updatedTimesheetData);
  };
                  ...
                  return (
                    <div key={taskIndex} style={{ marginBottom: "45px" }}>
                      <TextField
                        ...
                        onChange={(e) => handleSaveEdit(task.taskID, day, e.target.value)} // Calls `handleSaveEdit` on change
                        autoFocus
